...
export default function Footer() {
  return (
    <footer className="border-t border-white/30 bg-white/25 backdrop-blur-sm py-12">
      <div className="max-w-5xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          <div>
            ...
            <p className="text-sm text-gray-700 leading-relaxed mb-3">
              ...
              {/* <br />
              Think better <br /> Answer faster */}
            </p>
            <Link href="/#ghost" className="flex items-center gap-1.5 text-xs text-gray-600 hover:text-gray-900 transition-colors">
        ...
        <div className="mt-10 pt-6 border-t border-white/30 flex flex-col sm:flex-row items-center justify-between gap-2 text-sm text-gray-600">
