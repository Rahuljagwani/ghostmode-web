    ...
    <div className="max-w-3xl mx-auto px-6 py-24">
      ...
      <div className="prose prose-gray max-w-none space-y-8 text-gray-600 text-sm leading-relaxed">
        ...
        <section>
          ...
          <h3 className="text-base font-medium text-gray-900 mb-2 mt-4">Payment Information</h3>
          ...
          <h3 className="text-base font-medium text-gray-900 mb-2 mt-4">Screenshots and Voice Data</h3>
          <p>
            ...
            <strong className="text-gray-900"> not stored on our servers</strong> after the response is generated.
          </p>
        </section>
