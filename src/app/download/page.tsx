    ...
    <div className="max-w-4xl mx-auto px-6 py-24">
      ...
      <div className="bg-white/35 backdrop-blur-xl border border-white/50 rounded-2xl p-10 text-center mb-6 shadow-xl">
        ...
        <a
          ...
          className="bg-white hover:bg-white/90 text-gray-800 px-10 py-3.5 rounded-xl font-medium text-lg transition-colors inline-flex items-center gap-2 mb-4 shadow-lg"
        >
        ...
        {primary === "windows" && (
          <div className="mt-3">
            <a
              ...
              className="text-gray-600 hover:text-gray-900 text-sm font-medium inline-flex items-center gap-1.5 transition-colors"
            >
        ...
        <ol className="space-y-4">
          {platforms[primary].instructions.map((step, i) => (
            <li key={i} className="flex gap-3">
              <span className="w-6 h-6 rounded-full bg-white/30 text-gray-800 text-sm flex items-center justify-center shrink-0 mt-0.5 font-medium">
                {i + 1}
              </span>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5 border border-white/15">
              ...
              <ol className="space-y-2 text-sm text-white/70">
                <li className="flex gap-2">
                  <span className="text-white font-medium shrink-0">1.</span>
                  Run <code className="bg-white/10 px-1.5 py-0.5 rounded text-xs">Ghost-Setup.exe</code>
                </li>
                <li className="flex gap-2">
                  <span className="text-white font-medium shrink-0">2.</span>
                  Click <strong className="text-amber-300">&quot;More info&quot;</strong> on the blue warning
                </li>
                <li className="flex gap-2">
                  <span className="text-white font-medium shrink-0">3.</span>
                  Click <strong className="text-amber-300">&quot;Run anyway&quot;</strong>
                </li>
              </ol>
            </div>

            {/* Option B: ZIP */}
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5 border border-emerald-400/20">
              <h4 className="font-semibold text-white text-sm mb-3 flex items-center gap-2">
              ...
              <ol className="space-y-2 text-sm text-white/70">
                <li className="flex gap-2">
                  ...
                  Download <code className="bg-white/10 px-1.5 py-0.5 rounded text-xs">Ghost-Portable.zip</code>
                </li>
                <li className="flex gap-2">
                  <span className="text-emerald-400 font-medium shrink-0">2.</span>
                  Extract with <a href="https://7-zip.org" target="_blank" rel="noopener" className="text-amber-300 hover:underline">7-Zip</a> (free)
                </li>
                <li className="flex gap-2">
                  <span className="text-emerald-400 font-medium shrink-0">3.</span>
                  Run <code className="bg-white/10 px-1.5 py-0.5 rounded text-xs">Ghost.exe</code> — no warnings
                </li>
              </ol>
            </div>
          </div>

          <p className="text-xs text-white/50 mt-4 flex items-start gap-1.5">
        ...
        <div className="bg-white/35 backdrop-blur-xl border border-white/50 rounded-2xl p-6 shadow-xl">
          ...
          <ul className="text-sm text-gray-600 space-y-2">
            <li className="flex items-start gap-2">
              <CheckCircle className="w-3.5 h-3.5 text-emerald-300 mt-0.5 shrink-0" />
